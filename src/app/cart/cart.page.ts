...
import { IonContent, IonHeader, IonTitle, IonToolbar,IonButton,IonIcon,IonText,IonList,IonBadge,IonGrid,IonRow,IonCol,IonFab,IonFabButton,IonModal,IonItem,IonButtons } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule,IonButton,IonIcon,IonText,IonList,IonBadge,IonGrid,IonRow,IonCol,IonFab,IonFabButton,IonModal,IonItem,IonButtons,CrtComponent]
})
